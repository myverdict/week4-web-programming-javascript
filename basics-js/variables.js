...
console.log(
  "2 numbers concatenated with a string: Arithmetic calculation is performed first"
);
...
console.log(
  "Template string with arithmetic perfomed inside a placeholder using 2 integer variables: "
);
